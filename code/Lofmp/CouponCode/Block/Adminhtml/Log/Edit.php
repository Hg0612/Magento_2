 ...
 */
namespace Lofmp\CouponCode\Block\Adminhtml\Log;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    {
        if ($this->_coreRegistry->registry('lofmpcouponcode_log')->getId()) {
            return __("Edit Form '%1'", $this->escapeHtml($this->_coreRegistry->registry('lofmpcouponcode_log')->getCouponCode()));
        } else {
