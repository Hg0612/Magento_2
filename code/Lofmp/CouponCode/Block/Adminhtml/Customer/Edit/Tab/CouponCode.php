 ...
 */
namespace Lofmp\CouponCode\Block\Adminhtml\Customer\Edit\Tab;
...
class CouponCode extends \Magento\Backend\Block\Widget\Grid\Extended
{
     ...
     * @param \Lofmp\CouponCode\Model\Coupon
     * @param array
     */
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                'header' => __('Action'),
                'type' => 'action',
                'renderer'  => 'Lofmp\CouponCode\Block\Adminhtml\Coupon\Renderer\CouponAction',
            ]
            );
