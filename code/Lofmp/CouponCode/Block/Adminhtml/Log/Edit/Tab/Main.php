 ...
 */
namespace Lofmp\CouponCode\Block\Adminhtml\Log\Edit\Tab;
...
class Main extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    {
        $model = $this->_coreRegistry->registry('lofmpcouponcode_log');
        if ($this->_isAllowedAction('Lofmp_CouponCode::log_edit')) {
