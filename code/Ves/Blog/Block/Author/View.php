...
class View extends \Magento\Framework\View\Element\Template
{
    ...
    {   
        ...
        $this->pageConfig->addBodyClass('vesblog-page blogauthor-' . $author->getUsername());

        $page_title = $author->getPageTitle();
        $meta_description = $author->getMetaDescription();
        $meta_keywords = $author->getMetaKeywords();
