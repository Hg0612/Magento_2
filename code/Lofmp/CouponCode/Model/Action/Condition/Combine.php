 ...
 */
namespace Lofmp\CouponCode\Model\Action\Condition;
...
class Combine extends \Magento\Rule\Model\Condition\Combine
{
    ...
    public function __construct(
        ...
        \Lofmp\CouponCode\Model\Action\Condition\CustomerFactory $customerFactory,
        \Lofmp\CouponCode\Model\Action\Condition\BehaviorFactory $behaviorFactory,
        array $data = []
    ) {
        ...
        $this->setType('Lofmp\CouponCode\Model\Action\Condition\Combine');
    }
    ...
    protected function _getCustomerBehaviorConditions()
    {
        ...
        foreach ($customerAttributes as $code => $label) {
            $attributes[] = [
                'value' => 'Lofmp\CouponCode\Model\Action\Condition\Customer|' . $code,
                'label' => $label,
            ];
        }
        ...
        foreach ($customerRe as $code => $label) {
            $attributes2[] = [
                'value' => 'Lofmp\CouponCode\Model\Action\Condition\Behavior|' . $code,
                'label' => $label,
            ];
        }
        ...
        $conditions = array_merge_recursive(
            ...
            [
                [
                    ...
                    'value' => 'Lofmp\CouponCode\Model\Action\Condition\Combine|' . Rule::BEHAVIOR
                ],
                [
