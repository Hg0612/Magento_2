...
class Save extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create('Lof\MpFaq\Model\Setting')->load($seller_id);
            $model->setData($data);
            $model->setSellerId($seller_id);

            try {
                $model->save();
                $this->messageManager->addSuccess(__('You saved the setting.'));
        ...
        return $resultRedirect->setPath('catalog/faqsetting/index');
    }
}
