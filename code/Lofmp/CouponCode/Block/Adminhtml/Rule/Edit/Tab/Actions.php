 ...
 */
namespace Lofmp\CouponCode\Block\Adminhtml\Rule\Edit\Tab;
    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    public function __construct(
        ...
        \Lofmp\CouponCode\Model\Action $actionModel,
        array $data = []
    ) {
    ...
    {
        $model = $this->_coreRegistry->registry('lofmpcouponcode_rule');
    ...
    protected function addBehaviorConditions(\Magento\Framework\Data\Form $form, \Lofmp\CouponCode\Model\Rule $model) {  
    ...
    protected function addOrginalField(\Magento\Framework\Data\Form $form, \Lofmp\CouponCode\Model\Rule $model)
    {
        $fieldset = $form->addFieldset(
            'action_fieldset',
            ['legend' => __('Actions')]
