 ...
 */
namespace Lofmp\CouponCode\Controller\Adminhtml\Import;
...
class Save extends \Magento\Backend\App\Action
{
    ...
    */
                ...
                if($code_index !== false && $rule_id_index !== false) {
                    ...
                    foreach($importData as $item_data) {
                        ...
                        if($coupon_code && $rule_id) {
                            $coupon_model = $this->_objectManager->create('Lofmp\CouponCode\Model\Coupon');
                            $rule_model = $this->_objectManager->create('Lofmp\CouponCode\Model\ResourceModel\Rule');
    ...
    {
        return $this->_authorization->isAllowed('Lofmp_CouponCode::import_coupon');
    }
}
