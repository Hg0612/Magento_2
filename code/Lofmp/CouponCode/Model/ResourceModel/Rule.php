...
// --------------------------. GET all rules
        ...
        {
            $connection = $this->getConnection();
            $select = $connection->select()->from($this->getTable('lofmp_couponcode_rule'))->join(array('salesrule' => $this->getTable('salesrule')), 'lofmp_couponcode_rule.rule_id = salesrule.rule_id');
