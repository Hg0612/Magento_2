...
class CouponManagement implements CouponManagementInterface
{
    ...
    public function set($cartId, $couponCode)
    {
        ...
        $coupon_collection = $objectManager->create('Lofmp\CouponCode\Model\Coupon')->getCollection();
    ...
    public function getCouponAlias($alias){
        ...
        $coupon_model = $this->_objectManager->create('Lofmp\CouponCode\Model\Coupon')->getCouponByAlias($alias);
