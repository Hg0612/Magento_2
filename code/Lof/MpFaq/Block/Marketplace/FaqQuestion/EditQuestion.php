...
namespace Lof\MpFaq\Block\Marketplace\FaqQuestion;

class EditQuestion extends \Magento\Framework\View\Element\Template {
    ...
    public function __construct(
        ...
        $this->_currentQuestion = $this->_coreRegistry->registry('mpfaq_currentQuestion');
        $this->_productList = $this->_coreRegistry->registry('mpfaq_productList');
    ...
    public function _prepareLayout() {
        $this->pageConfig->getTitle ()->set(__('Edit Question'));
