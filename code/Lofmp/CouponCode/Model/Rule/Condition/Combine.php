 ...
 */
namespace Lofmp\CouponCode\Model\Rule\Condition;
...
class Combine extends \Magento\Rule\Model\Condition\Combine
{
    ...
    public function __construct(
        ...
        \Lofmp\CouponCode\Model\Rule\Condition\Address $conditionAddress,
        array $data = []
    ) {
        $this->_eventManager = $eventManager;
        $this->_conditionAddress = $conditionAddress;
        parent::__construct($context, $data);
        $this->setType('Lofmp\CouponCode\Model\Rule\Condition\Combine');
    }
    ...
    public function _getCartConditions() 
    {
        ...
        foreach ($addressAttributes as $code => $label) {
            $attributes[] = [
                'value' => 'Lofmp\CouponCode\Model\Rule\Condition\Address|' . $code,
                'label' => $label,
            ];
        }
