...
class EditCategory extends \Magento\Framework\View\Element\Template {
    ...
    public function __construct(
        ...
        $this->_currentCategory = $this->_coreRegistry->registry('mpfaq_currentCategory');
    ...
    public function _prepareLayout() {
        $this->pageConfig->getTitle ()->set(__('Edit Category'));
