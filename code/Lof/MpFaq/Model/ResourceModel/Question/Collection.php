...
namespace Lof\MpFaq\Model\ResourceModel\Question;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        $this->_init('Lof\MpFaq\Model\Question', 'Lof\MpFaq\Model\ResourceModel\Question');
    }
    ...
    public function getCategoryTitle(){
        $this->getSelect()->join(
            ['category' => $this->getTable('lof_mpfaq_category')],
