 ...
 */
namespace Lofmp\CouponCode\Block\Adminhtml\Rule;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Lofmp_CouponCode::rule_save')) { 
        ...
        if ($this->_isAllowedAction('Lofmp_CouponCode::rule_delete')) {
    ...
    {
        if ($this->_coreRegistry->registry('lofmpcouponcode_rule')->getId()) {
            return __("Edit Form '%1'", $this->escapeHtml($this->_coreRegistry->registry('lofmpcouponcode_rule')->getTitle()));
        } else {
            return __('New Form');
        }
    }
