...
namespace Lofmp\CouponCode\Model\ResourceModel\Sales;
class  Collection extends \Lofmp\CouponCode\Model\ResourceModel\AbstractReport\Ordercollection
{
    ...
    public function prepareByCouponCollection() {
        ...
        $this->getSelect()->join(array('lofcoupon'=>'lofmp_couponcode_coupon'),'lofcoupon.code=main_table.coupon_code','code'); 
        $this->getSelect()
