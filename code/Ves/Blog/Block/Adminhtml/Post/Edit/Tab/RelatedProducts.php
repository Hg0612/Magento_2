...
class RelatedProducts extends Extended
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            'index' => 'position',
            'editable' => !$this->getPost()->getRelatedReadonly(),
            'edit_only' => !$this->getPost()->getId(),
    ...
    public function getSelectedRelatedProducts()
    {
        $post = $this->getPost();
        $products = [];
        if(!empty($post->getRelatedProducts())){
    ...
    public function filterProductPosition($collection, $column)
    {
        ...
        $post = $this->getPost();
        $condition['post_id'] = $post->getPostId();
