...
class Edit extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Lofmp\CouponCode\Model\Log');
        ...
        $this->_coreRegistry->register('lofmpcouponcode_log', $model);  
    ...
    {
        return $this->_authorization->isAllowed('Lofmp_CouponCode::log_edit');
    }
}
