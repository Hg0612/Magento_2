 ...
 */
namespace Lofmp\CouponCode\Controller\Adminhtml\Report\Sales;

class Coupon extends \Lofmp\CouponCode\Controller\Adminhtml\Report\Sales
{
    /**
    ...
    {     
        ...
        $this->_initAction()->_setActiveMenu(
            'Lofmp_CouponCode::salesbycoupon'
        )->_addBreadcrumb(
            __('Sales By Coupon'),
            __('Sales By Coupon') 
        );
