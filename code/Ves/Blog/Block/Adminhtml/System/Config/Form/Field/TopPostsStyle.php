...
class TopPostsStyle extends \Magento\Config\Block\System\Config\Form\Field
{
    ...
    {
        $html = '';
        $patternUrl = $this->_storeManager->getStore()->getBaseUrl(\Magento\Framework\UrlInterface::URL_TYPE_MEDIA).'ves/blog/postsstyle';

        $options = $element->getValues();
        $html .= '<div class="blog-postsstyle" id="' . $element->getHtmlId() . '">';
