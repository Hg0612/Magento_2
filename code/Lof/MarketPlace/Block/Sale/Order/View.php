...
class View extends \Magento\Framework\View\Element\Template
{
    ...
    */
    ...
    public function getOrderItems($product_id) {
        $orderitems = $this->orderitems->getCollection()->addFieldToFilter('seller_id',$this->helper->getSellerIdByProduct($product_id))->addFieldToFilter('order_id',$this->getOrderId())->addFieldToFilter('product_id',$product_id)->getFirstItem();
        return $orderitems;
    }
    /**
