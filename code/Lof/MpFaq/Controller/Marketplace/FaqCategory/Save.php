...
namespace Lof\MpFaq\Controller\Marketplace\FaqCategory;
    ...
    public function execute()
    {
        ...
        if ($data) {
            if(!isset($data['category_id'])) {
                ...
                $id = $data['category_id'];
                $model = $this->_objectManager->create('Lof\MpFaq\Model\Category')->load($id);
                ...
                $parentCategory = $this->_objectManager->create('Lof\MpFaq\Model\Category')->load($parentId);
