 ...
 */
namespace Lofmp\CouponCode\Block\Adminhtml\Coupon;
...
class Import extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Lofmp_CouponCode::coupon_import')) {
    ...
    {
        if ($this->_coreRegistry->registry('lofmpcouponcode_coupon')->getId()) {
            return __("Edit Form '%1'", $this->escapeHtml($this->_coreRegistry->registry('lofmpcouponcode_coupon')->getName()));
        } else {
            return __('New Form');
        }
    }
