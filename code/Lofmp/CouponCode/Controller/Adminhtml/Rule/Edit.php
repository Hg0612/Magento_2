...
class Edit extends \Lofmp\CouponCode\Controller\Adminhtml\Rule
{
    /**
    ...
    {
        return $this->_authorization->isAllowed('Lofmp_CouponCode::rule_edit');
    }
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('lofmpcouponcode_rule', $model);  
